...
/// whose identity was <em>inherited</em> (<see cref="AttributionSource.TestContext"/> or
/// <see cref="AttributionSource.GlobalFallback"/>) and that started after the scenario ended is the host's
