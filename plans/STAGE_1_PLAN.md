...
|---|---|---|---|---|
| P1. The ingest feed loses nothing. **Executing:** [`INGEST_FEED_PLAN.md`](INGEST_FEED_PLAN.md) (2026-09-22; revised the same evening: S2 prototyped and measured byte-identical against a real suite, F7 added; **R1 shipped as 3.27.4 on 2026-09-23**, R2 3.28.0 and R3 next) | 1.3, 1.4, 1.7 | Ingestion records, the ingest command (tracks D and A) | one patch, then one minor | D4 |
