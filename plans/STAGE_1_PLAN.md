...
nothing, and each plan it names is a file of its own. **At 2026-09-25 (3.29.6):** P1 and P2 are
executed; P3 is executing, its first release shipped as 3.29.6; P4 and P5 are written, and neither is
green-lit. Each row says where its plan stands.
