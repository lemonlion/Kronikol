...
| **BDD framework steps** | ReqNRoll/BDDfy/LightBDD decorators | **Cucumber-js** `BeforeStep`/`AfterStep` → Gherkin Given/When/Then for free; **Playwright** native `test.step()` → hook | **1 — free where the runner has steps** |
